...
#'
#' Descending version of the `reorder` function.
#' Reorders levels of a factor based on descending order of values of a second variable (usually numeric).
#'
...
#'
#' @return A factor with the order of the levels determined by FUN applied to y grouped by x.
#' The levels are ordered such that the values returned by FUN are in descreasing order.
#'
#' @examples
#' x <- c("a", "d", "h", "g", "m")
#' y <- c(1, 3, 9, 7, 6)
